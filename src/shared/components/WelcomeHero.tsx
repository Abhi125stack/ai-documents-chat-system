...
export function WelcomeHero() {
  ...
  return (
    <div className="relative overflow-hidden p-8 rounded-4xl bg-[#0d1525]/20 border border-white/5 backdrop-blur-3xl shadow-2xl">
      {/* Decorative Glow */}
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        <div className="space-y-6">
          ...
          <div className="text-3xl lg:text-4xl font-extrabold text-white leading-tight tracking-tight">
        ...
        <div className="grid grid-cols-2 gap-4">
          {stats.map((stat, i) => (
            <div key={i} className="p-4 rounded-4xl bg-white/3 border border-white/5 hover:border-white/10 transition-all group overflow-hidden relative">
